...
* **Use your browser**: There are two options: 
    ...
    **Option 1: Edit directly from docs.microsoft.com**  
    ...
    3. Select the pencil icon. When you hover over the pencil icon, you'll seee the **Edit this file** tooltip. 
    ...
    **Option 2: Find the article in this repository, and update**  
    ...
    2. Select the link, and click the pencil icon. When you hover over the pencil icon, you'll seee the **Edit this file** tooltip. 
