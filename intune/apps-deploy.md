...
8. For the specific app, select an **assignment type**:
   ...
   - **Available with or without enrollment**: Assign this app to groups of users whose devices are not enrolled with Intune. Apps from Managed Google Play and macOS LOB apps don't support this option. 
