...
| **Require minimum iOS operating system** | Choose **Yes** to require a minimum iOS operating system to use this app. The user will be blocked from access if the iOS version on the device does not meet the requirement. <br><br> This policy setting format supports a single decimal point, like iOS 10.3. <br><br> **Note:** Requires app to have Intune SDK version 7.0.1 or above. | No |
| **Require minimum iOS operating system (Warning only)** | Choose **Yes** to require a minimum iOS operating system to use this app. The user will see a notification if the iOS version on the device does not meet the requirement. This notification can be dismissed. <br><br> This policy setting format supports a single decimal point, like iOS 10.3. <br><br> **Note:** Requires app to have Intune SDK version 7.0.1 or above. | No |
