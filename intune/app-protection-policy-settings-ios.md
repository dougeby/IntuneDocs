...
<li>**Contact sync**: The Edge browser does not save to native contact lists.</li></ul><br>**Note**:<br>The APP SDK cannot determine if a target app is a browser. On iOS devices, no other managed browser apps are allowed. <br><br>Default value = **Any app** |
