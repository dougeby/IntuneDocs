...
|Setting  |Windows version  |Details  |
|---------|-----------------|---------|
|Cache server host names |   |Specify by IP address or FQDN the Network Cache servers that will be used by your devices for delivery optimization, and then select **Add** to add it to the list.  <br><br>**Default**: Not configured  <br><br>Policy CSP: [DOCacheHost](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-deliveryoptimization#deliveryoptimization-docachehost)  |
