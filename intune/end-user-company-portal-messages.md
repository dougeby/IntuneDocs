...
The Company Portal needs to be added to  Allow or exempt list in the Windows Information Protection (WIP) app protection policy. For more information, see [Create and deploy Windows Information Protection (WIP) app protection policy with Intune](/intune/end-user-company-portal-messages.md).
