...
<img alt="iOS app message - Untrusted Enterprise Developer" src="./media/end-user-company-portal-messages/end-user-company-portal-messages-01.png" width="200">
...
6. Confirm the app by selecting **Trust** on the app install pop-up message.
    ...
    <img alt="iOS device UI - Trust app message" src="./media/end-user-company-portal-messages/end-user-company-portal-messages-03.png" width="200">
