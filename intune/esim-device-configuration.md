...
The eSIM profile is also removed when the device is unenrolled by the user, or when the [remove company data](devices-wipe.md#retire) or [reset device remote action](devices-wipe.md#factory-reset) runs on the device.
