...
The eSIM profile is also removed when the device is [retired](devices-wipe.md#retire) or unenrolled by the user, or when the [reset device remote action](devices-wipe.md#factory-reset) runs on the device.
