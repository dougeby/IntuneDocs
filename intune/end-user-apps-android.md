...
Your end users need to allow installation from unknown sources to install [LOB apps](lob-apps-android.md). This setting is normally found in two different places:
