...
For example, you can create a scope tag called “Engineering Department” and assign it to configuration profiles related to the engineering department. Then, you can assign that same tag to an “Engineering Administrators” role so that they can only see the policies with the “Engineering Department” tag.
