...
| [VPP]() | xxx | Apple User ID | A user id generated by Apple. |
| [VPP]() | xxx | application description | The description of a VPP application. |
| [VPP]() | xxx | application icon | The URL of an Apple hosted icon for a VPP app. |
| [VPP]() | xxx | Application Id | Apple Application id, also known as adamsId. |
| [VPP]() | xxx | application name | The name of a VPP application. |
| [VPP]() | xxx | assignedCount | The number of assigned licenses for an app. |
| [VPP]() | xxx | availableCount | The number of unassigned licenses for an app. |
| [VPP]() | xxx | bundleId | The bundleId of an app. |
| [VPP]() | xxx | copyright | The copyright info of an app. |
| [VPP]() | xxx | CountryCode | The country code of a VPP program. |
| [VPP]() | xxx | deviceAssignable | Apple returns true if the admin can assign a device license for an app. If not, false is returned. |
| [VPP]() | xxx | facilitatorMemberId | The member id of a VPP account facilitator.  |
| [VPP]() | xxx | genres | The genres of an app. |
| [VPP]() | xxx | Intune UserId guid | The GUID generated by Intune. |
| [VPP]() | xxx | isIrrevocable | Apple returns true if the license can’t be revoked. If it can be revoked, false is returned. |
| [VPP]() | xxx | License Id | The id generated by apple to identify a specific license. |
| [VPP]() | xxx | Location | Location stored in apple VPP config data. |
| [VPP]() | xxx | Managed AppleId UPN | The AppleID email for user, admin, and facilitator member. |
| [VPP]() | xxx | OrganizationId | The Apple assigned organization id. |
| [VPP]() | xxx | pricingParam | The Apple pricing type for an app. |
| [VPP]() | xxx | productType | The product type of a VPP application. |
| [VPP]() | xxx | retiredCount | The number of retired licenses for an app. |
| [VPP]() | xxx | totalCount | The total number of licenses purchased for an app. |
| [VPP]() | xxx | url | The iTunes store URL of an app.|
| [VPP]() | xxx | User Status | The user status in apple VPP programs. |
