...
> 
> Also, be aware that Android apps deployed as **Available with or without enrollment** only report app installation status for enrolled devices. This information will not be available for devices not enrolled in Intune.
