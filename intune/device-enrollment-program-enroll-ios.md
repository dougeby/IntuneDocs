...
**Step 1. Download the Intune public key certificate required to create the token.**<br>
...
**Step 2. Use your key to download a token from Apple.**<br>
...
**Step 3. Save the Apple ID used to create this token.**<br>
