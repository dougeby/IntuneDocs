...
2. If you want to include [scope tags](scope-tags.md) with this DEP token, choose **Scope (tags)**, and select the scope tags that you want. Scope tags applied to a token will be inherited by profiles and devices added to this token.
3. Choose **Create**.
