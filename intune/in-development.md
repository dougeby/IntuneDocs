...
Using profiles, you'll be able to configure settings that apply certificates, VPNs, email, and Wi-Fi settings to your Android Enterprise fully managed devices. You'll be able to:
...
### Intune support to support iOS 11 and later <!-- 4665324  -->
Intune enrollment, Company Portal, and Managed Browser will stop supporting iOS versions older than iOS 11.
