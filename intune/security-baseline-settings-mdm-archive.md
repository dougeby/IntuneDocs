...
- View the settings that are available in [the current MDM security baseline](security-baseline-settings-mdm-all.md) 
...
*This baseline is superseded by [MDM Security Baseline for May 2019](security-baseline-settings-mdm-all.md)*
...
[View the current baseline version](security-baseline-settings-mdm-all.md)  
