...
By configuring device groups ahead of device enrollment, you can use device categories to auto-group devices upon enrollment to receive their group’s device policies automatically. [Get started with groups](groups-get-started.md). <!---Q out to NB re "auto-group" vs dynamic groups--->
