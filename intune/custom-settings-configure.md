...
description: Add or create a profile to use custom settings for Windows Phone, Windows 8.1, Windows 10 and later, Android, Anndroid Enterprise, macOS, and iOS devices using Microsoft Intune
keywords:
