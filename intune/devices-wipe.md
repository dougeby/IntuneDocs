...
You can configure Intune to automatically remove devices that appear to be inactive, stale, or unresponsive. These cleanup rules continuously monitor your device inventory so that your device records stay current.
1. Sign in to the [Intune in the Azure portal](https://aka.ms/intuneportal).
...
Devices deleted in this way are removed from Intune management.
