...
### [Set the MDM authority](enroll-devices/set-mdm-authority.md?toc=/intune/toc.json)
...
#### [Home screen layout for iOS](chome-screen-settings-ios.md)
...
#### [Windows 8.1 & Windows 10](wi-fi-settings-windows-8-1.md)
