...
This setting allows you to configure which browser app your users will be directed to use. If this setting is set to "True", Microsoft Edge will be set as the browser your users are prompted to use. If the value is set to "False" your users will continue to be directed to use the Managed Browser.
