...
If enrolling Android work profile devices with a [Device Enrollment Manager](device-enrollment-manager-enroll.md) account, there is a limit of 10 devices that may be enrolled per account.
