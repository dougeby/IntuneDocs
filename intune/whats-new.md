...
The Company Portal app for macOS is now available as part of the public preview for conditional access in EMS. This release supports macOS 10.11Get it at [https://aka.ms/macOScompanyportal](https://aka.ms/macOScompanyportal). 
