...
<sup>3</sup> Intune supports available apps from Managed Google Play store on Android Enterprise devices. The Intune app must be used to install apps on Android Enterprise devices, rather than installing from the Company Portal app.<br>
