...
To view monitoring data for the baseline and devices, sign in to the [Intune portal](https://aka.ms/intuneportal). Next, select **Security Baselines (preview)**, select a baseline, and view the **Overview** pane.
