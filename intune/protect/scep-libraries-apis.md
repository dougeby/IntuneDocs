...
3. [Configure the SCEP Server](protect/certificates-scep-configure.md) with the IDs and key created when onboarding your SCEP server.
...
5. [Create a Trusted Root Certificate profile](protect/certificates-scep-configure.md) for your test Certificate Authority.
...
- [Add 3rd party CA overview](protect/certificate-authority-add-scep-overview.md)
