...
> [!IMPORTANT]
> Compliance policies also apply Android Enterprise Dedicated Devices, also known as kiosks. If a compliance policy is assigned to a dedicated device, the device may show as “Not Compliant”. Be sure to complete any tasks or actions to get the dedicated device compliant with your assigned policies.
