...
> [!IMPORTANT]  
> For all supported iOS versions, use ***iTunes*** instead of ***apps*** for the apple.com portion of the URL. Use of *apps* will fail. We are working on a fix for this in a future release. When fixed, you'll be able to use either *iTunes* or *apps* in the URL.  
>  
> Example for MS Word:  
