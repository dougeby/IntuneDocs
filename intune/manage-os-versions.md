...
|![Image of the Android update warning dialog](./media/os-version-update-warning.png)    |![Image of the App access blocked dialog](./media/os-version-access-blocked.png)          |
