...
- Mac OS X 10.11 and later (in December 2018, the supported version will change to 10.12 and later)
...
Customers with Enterprise Management + Security  (EMS) can also [use Azure Active Directory (Azure AD) to register Windows 10 devices](windows-enroll.md#azure-active-directory-enrollment).
