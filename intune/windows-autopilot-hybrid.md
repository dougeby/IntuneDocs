...
8. Go to **Device enrollment** > **Windows enrollment** > **Intune Connector for Active Directory (Preview)**, and then confirm that the connection status is **Active**.
 ...
 > [!NOTE]
 > After you sign in to the Connector, it might take a couple of minutes for it to appear in [Intune](https://aka.ms/intuneportal). It will appear only if it can successfully communicate with the Intune service.
