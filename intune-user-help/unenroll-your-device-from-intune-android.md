...
> [!NOTE]
> You can't unenroll or remove your corporate-owned device from the Microsoft Intune app. The device was enrolled during initial device setup and must be enrolled to use.  
