...
description: "Intune Azure preview: Intune gives you the tools to proactively deploy a new provisioning profile policy to devices that have apps that are nearing expiry."
keywords:
author: robstackmsft
ms.author: robstack
manager: angrobe
