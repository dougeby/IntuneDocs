...
3.  **Azure AD** blade opens, choose **Mobility (MDM and MAM)**, then click **Microsoft Intune**.
    ...
    ![Mobility MDM and MAM](../media/AppManagement/mam-provider-sc-1.png)
...
[Create a WIP app protection policy](https://docs.microsoft.com/intune-azure/manage-apps/create-windows-information-protection-policy-with-intune)
