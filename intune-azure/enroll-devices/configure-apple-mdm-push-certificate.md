...
title: Configure an MDM push certificate in Microsoft Intune | Microsoft Docs
...
# Configure an MDM push certificate in Microsoft Intune
...
2.  In the **Enrollment** workload, choose **Apple Enrollment**.
