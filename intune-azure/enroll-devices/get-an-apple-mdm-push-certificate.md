...
title: Get an Apple MDM Push certificate | Microsoft Docs
description: 
keywords:
author: staciebarker
ms.author: stabar
...
Open the **Enrollment** workload, choose **Apple MDM Push Certificate**, and then follow the numbered steps in the Azure portal, which are shown below.
