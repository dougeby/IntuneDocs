...
title: How to create a compliance profile for Android for work | Microsoft Docs
description: Learn how to create a compliance profile for Android for work devices.
keywords:
...
Compliance profiles are created for each platform.  You can create a compliance profile in the Azure portal. To learn more about what compliance profile is see [What is  device compliance ](what-is-device-compliance.md) topic. To learn about the prerequisites that you need to address before creating a compliance profile see [Get started with device compliance](get-started-with-device-compliance.md) topic.
...
|**Profile setting**| **Android for Work** |
| --- | --- |
