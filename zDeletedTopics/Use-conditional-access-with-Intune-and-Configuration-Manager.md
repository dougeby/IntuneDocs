...
![](./media/Hybrid_on-prem_CA_architecture.png)
...
3.  Click **Synchronize Now**.
    ...
    ![](./media/HybridOnpremRunFullSync.png)
...
> 
> ![](./media/HybridOnpremExchSrvrWizard6.PNG)
> 
...
If you don’t have a large number of users already enrolled in Intune, conditional access provides them with a guided experience for enrollment, as described in [End-user experience of conditional access](end-user-experience-of-conditional-access.md).
...
![](./media/HybridOnpremEasDiscLogSample.PNG)
...
![](./media/HybridOnpremVerifyDevicesState.png)
...
![](./media/HybridReportsDeploymentStatus.png)
...
![](./media/Hybrid_Exchange-Online_CA_architecture.png)
