...
1.  Retire the computer, as described in [Retire data and devices from Microsoft Intune management](/intune/deploy-use/retire-data-and-devices-from-microsoft-intune-management).
