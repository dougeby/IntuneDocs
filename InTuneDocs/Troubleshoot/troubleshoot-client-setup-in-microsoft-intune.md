...
|**0x80043001**|Enrollment package is out of date.|Download and install the current client software package from the **Admin** workspace. For instructions, see the [Install the Windows PC client with Microsoft Intune](intune/deploy-use/install-the-windows-pc-client-with-microsoft-intune) topic.|
