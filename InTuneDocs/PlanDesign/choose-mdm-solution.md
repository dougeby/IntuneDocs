...
<!-- deprecated
Learn more about the differences between [MDM in Office 365 and Intune](/intune/understand-explore/choose-between-intune-and-mdm-for-office-365.html).
...
To help you decide between Intune standalone and Intune integrated with Configuration Manager for hybrid MDM, read the [detailed comparison of capabilities](/intune/understand-explore/choose-between-intune-and-hybrid.md).
