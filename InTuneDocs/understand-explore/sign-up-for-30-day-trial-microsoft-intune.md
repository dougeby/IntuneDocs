...
>[!Note]
> Starting in December 2012, Microsoft Intune is moving to the Azure portal, and some free trial sign ups will be in Intune in the Azure portal and some will be in classic Intune. If your trial is in the Azure portal, you will find [Intune Azure preview content](https://docs.microsoft.com/en-us/intune-azure/introduction/what-is-microsoft-intune) more useful.
