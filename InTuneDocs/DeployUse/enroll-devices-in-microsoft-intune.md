...
See [choose how to enroll devices](/intune/get-started/choose-how-to-enroll-devices1) for help.
...
[User Affinity](enroll-corporate-owned-ios-devices-in-microsoft-intune.md#using-company-portal-on-dep-or-apple-configurator-enrolled-devices) ([Back to the table](#overview-of-device-enrollment-methods))
