...
1.  In the Intune admin console, follow one of these series of steps:
    ...
    -   **To display summary data for alerts**, choose **Alerts**, and then choose **Overview**. On the **Alerts Overview** page, you can see a summary of alerts in the **Alert Type Summary** area. Critical alerts are listed first. Choose the links in these alerts to see more detailed information.
    ...
    -   **To display all active alerts**, choose **Alerts**, and then choose **All Alerts**. On the **Alerts** page, you can see a list of all active alerts. The page has these columns:
...
Notice board alerts provide important service announcements. They might provide information about an upcoming service upgrade or maintenance schedule, or the status of an outage. Use this procedure to view and manage notice board alerts:
...
- **To close an alert from the Alerts list**, choose **Alerts**, and then choose **All Alerts**. Select an alert, and then choose **Close Alert**.

- **To close an alert for a specific device**, choose **Groups**, and then choose **All Devices**. Select a device, and then choose **View Properties**. Then, on the **Alerts** tab, select an alert, and then choose **Close Alert**.
...
1.  In the Intune admin console, choose **Alerts**, and then choose **All Alerts**.
