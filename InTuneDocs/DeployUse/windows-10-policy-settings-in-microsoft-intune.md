...
For each OMA-URI setting that you want to add, enter the following information. Use the [Windows 10 URI settings reference](/intune/deploy-use/windows-10-policy-settings-in-microsoft-intune#Windows-10-URI-settings) in this topic to learn about the settings you can use:
...
- **Data type** - Choose from:
	...
	- **Floating point**
	- **Boolean**
- **OMA-URI (case sensitive)** - Specify the OMA-URI that you want to supply a setting for.
...
Use this section to learn about the OMA-URI settings that you can configure with a **Windows 10 Custom Policy**.

### Policy

|Policy name and URI|Details|
|---------------|------------|-----------|
|**​Allow Auto Update**<br>./Vendor/MSFT/Policy/Config/Update/AllowAutoUpdate|Desktop only<br>**Data type:** Integer<br />**Values:** **0** - **5** (default is **1**)|
...
|**Schedule Install Time**<br>./Vendor/MSFT/Policy/Config/Update/ScheduledInstallTime|Desktop and mobile<br />**Data type:** Integer<br />**Values:** **0** – **23** hours (**0** is midnight) (default is **3**)|
...
|**DaysToRetainCleanedMalware**<br>./Vendor/MSFT/Policy/Config/Defender/DaysToRetainCleanedMalware|Desktop only<br />**Data type:** Integer<br />**Values:**<br>**0** - **90** – Represents how long malware will be retained<br>**Default:** **0** – Keeps malware in the quarantine folder forever, and doesn’t automatically remove it|
...
|**AVGCPULoadFactor**<br>./Vendor/MSFT/Policy/Config/Defender/AVGCPULoadFactor|Desktop only<br />**Data type:** Integer<br />**Values:** **0** - **100** (default is **50**)|
...
|**ExcludedPaths**<br>./Vendor/MSFT/Policy/Config/Defender/ExcludedPaths|Desktop only<br />**Data type:** String<br />**Values:**<br />*&lt;List of paths separated by semi-colons&gt;*<br />Example: **c:\test;c:\test1.exe**<br />**Default value:** No paths are excluded|
|**ExcludedProcesses**<br>./Vendor/MSFT/Policy/Config/Defender/ExcludedProcesses|Desktop only<br />**Data type:** String<br />**Values:**<br>*&lt;List of paths separated by semi-colons&gt;*<br>Example: **c:\test.exe;c:\test1.exe**<br>**Default value:** No processes are excluded|
...
|**Configure SmartScreen**<br>./Vendor/MSFT/Policy/Config/Browser/AllowSmartScreen|Desktop and mobile<br />**Data type:** Integer<br />**Values:** **0** – Don't allow, **1** – Allow (default)|
|**Allow Pop-ups**<br>./Vendor/MSFT/Policy/Config/Browser/AllowPopups|Desktop only<br />**Data type:** Integer<br />**Values:** **0** – Block pop-up windows (default), **1** – Allow pop-up windows|
...
|**Required password type** - **Minimum number of character sets**|Specifies which of the four character sets (lowercase letters, uppercase letters, numbers, and symbols) must be included in the password.|
|**Minimum password length**|Applies to Windows 10 Mobile only|
|**Number of repeated sign-in failures to allow before the device is wiped**|For devices that are running Windows 10: If the device has BitLocker enabled, the device is put into BitLocker recovery mode after sign-in fails the number of times that you specified. If the device is not BitLocker enabled, then this setting doesn't apply.<br>For devices running Windows 10 Mobile: After sign-in fails the number of times you specify, the device is wiped.|
...
|**Allow Cortana**|Enables or disables the Cortana voice assistant|
|**Allow action center notifications**|Enables or disables action center notifications on the device lock screen<br>(Windows 10 Mobile only)|
...
|**Allow pre-release features**|Lets Microsoft deploy pre-release settings and features to Windows 10 devices. You can select to allow only settings to be installed, or you can allow all pre-release settings and features to be installed.|
