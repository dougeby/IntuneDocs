...
**Task 2**: Configure prerequisites on the NDES server
**Task 3**: Configure NDES for use with [!INCLUDE[wit_nextref](../Token/wit_nextref_md.md)]
...
### <a name="BKMK_ConfigOnPremTask2"></a>Task 2 - Configure prerequisites on the NDES server
In this task you will:
...
### <a name="BKMK_ConfigOnPremTask3"></a>Task 3 - Configure NDES for use with [!INCLUDE[wit_nextref](../Token/wit_nextref_md.md)]
In this task you will:
