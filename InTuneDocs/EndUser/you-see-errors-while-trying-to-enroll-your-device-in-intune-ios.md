...
|-----------------|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|NoEnrollmentPolicy|No enrollment policy|Tell your IT administrator to check that all enrollment prerequisites have been configured, such as the APNs certificate, and that "iOS as a platform" is enabled.|
