...
### [Configure a custom domain name](get-started/start-with-a-paid-subscription-to-microsoft-intune-step-2.md)
### [Synchronize AD and add users](get-started/start-with-a-paid-subscription-to-microsoft-intune-step-3.md)
...
### [Customize the Company Portal](get-started/start-with-a-paid-subscription-to-microsoft-intune-step-7.md)
