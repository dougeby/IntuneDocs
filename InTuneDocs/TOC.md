...
## [Migrate](plan-design/intune-mdm-migration-guide.md)
### [Phase 1: Prepare Intune for MDM](plan-design/migration-phase1-prepare-intune-for-mobile-device-management.md)
#### [Basic setup](plan-design/migration-phase1-basic-setup.md)
#### [Configure device and app management policies](plan-design/migration-phase1-configure-device-and-app-management-policies.md)
...
#### [PC policies](use-policies-to-simplify-windows-pc-management.md)
#### [View inventory](view-hardware-and-software-inventory-for-windows-pcs-in-microsoft-intune.md)
#### [Retire PCs](retire-a-windows-pc-with-microsoft-intune.md)
#### [Link PCs-users](manage-user-device-linking-for-windows-pcs-with-microsoft-intune.md)
#### [Remote assistance](request-and-provide-remote-assistance-for-windows-pcs-in-microsoft-intune.md)
