...
>[&larr; **Manage Intune licenses**](.\get-started-with-a-paid-subscription-to-microsoft-intune-step-4.md)       [**Create policies and apps** &rarr;](.\get-started-with-a-paid-subscription-to-microsoft-intune-step-6.md)  
