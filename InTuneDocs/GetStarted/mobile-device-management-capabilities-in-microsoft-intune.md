...
|iOS mobile app provisioning profiles|Intune gives you the tools to proactively deploy provisioning profiles to iOS apps that are nearing expiry.|[Use iOS mobile provisioning profile policies to prevent your apps from expiring](/intune/deploy-use/ios-mobile-app-provisioning-profiles)|
