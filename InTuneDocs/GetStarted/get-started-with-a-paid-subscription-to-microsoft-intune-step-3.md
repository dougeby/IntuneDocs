...
>[<< **Configure a custom domain name**](.\get-started-with-a-paid-subscription-to-microsoft-intune-step-2.md)     [**Manage Intune licenses** >>](.\get-started-with-a-paid-subscription-to-microsoft-intune-step-4.md)  
