...
>[<< **Manage Intune licenses**](.\get-started-with-a-paid-subscription-to-microsoft-intune-step-4.md)       [**Create policies and publish an app** >>](.\get-started-with-a-paid-subscription-to-microsoft-intune-step-6.md)  
