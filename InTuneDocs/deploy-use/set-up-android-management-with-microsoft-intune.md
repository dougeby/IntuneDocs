...
3.  **Tell your users how to enroll their devices to get access to company resources.**
	...
	For end-user enrollment instructions, see [Enroll your Android device in Intune](../../intune-user-help/enroll-your-device-in-intune-android.md). The enrollment process tells users what they can expect, and what IT administrators can and can't see on their devices.
  ...
  - [End user guidance for Android devices](../../intune-user-help/using-your-android-device-with-intune.md)
