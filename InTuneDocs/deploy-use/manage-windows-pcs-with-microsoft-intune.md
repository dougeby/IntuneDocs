...
> [!NOTE]
> You can manage Windows 8.1 or later devices either as PCs, by using the Intune client, or as mobile devices by using the mobile device management (MDM) functionality. You cannot use both methods together. This topic applies only to manage devices as PCs by running the Intune software client.
