...
The Intune managed browser supports opening web content from [Microsoft Intune application partners](https://www.microsoft.comserver-cloud/products/microsoft-intune/partners.aspx).
