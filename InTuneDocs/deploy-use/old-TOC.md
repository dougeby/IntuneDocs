<<<<<<< HEAD:InTuneDocs/DeployUse/TOC.md
...
##### [Setup Assistant enrollment](ios-setup-assistant-enrollment-in-microsoft-intune.md)
##### [Direct enrollment](ios-direct-enrollment-in-microsoft-intune.md)
##### [DEP enrollment](ios-device-enrollment-program-in-microsoft-intune.md)
...
##### [Use a custom policy to create a Wi-Fi profile with a pre-shared key](pre-shared-key-wi-fi-profile.md)
...
### [Deploy apps to Android for Work devices](android-for-work-apps.md)
...
# [Troubleshoot](/intune/troubleshoot/general-troubleshooting-tips-for-microsoft-intune)
>>>>>>> 3aec4e9522eca59d40edf0bf7c2b76adc9dd21ed:InTuneDocs/deploy-use/old-TOC.md
