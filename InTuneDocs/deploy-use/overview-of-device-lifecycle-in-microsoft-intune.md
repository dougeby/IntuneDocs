...
- [**Multi-factor authentication**](protect-your-devices-with-microsoft-intune#further-capabilities-for-windows-devices.md). Adding an extra layer of authentication to user sign-ins can help make devices even more secure. Windows, Windows Phone, and Windows Mobile devices offer multi-factor authentication that requires a second level of authentication, such as a phone call or text message, before users can gain access.
