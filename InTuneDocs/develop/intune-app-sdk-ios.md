...
`MAMPolicyRequired` | Boolean| Specifies whther the app will be blocked from launching if the app does not have Intune MAM policy. Note: apps cannot be submitted to the store with this setting to YES| Optional. Defaults to NO 
